  ...
  <div>
    <h2>
      ...
      <button class="btn btn-primary float-right" @click="refresh()" :disabled="updatingRoutes">
        <font-awesome-icon icon="sync"></font-awesome-icon> <span>Actualizar</span>
      </button>
    </h2>
      ...
      <table class="table table-striped">
        ...
        <tbody>
          <tr v-for="route of gatewayRoutes" :key="route.serviceId">
            ...
            <td>
              <div v-if="route.serviceInstances.length === 0" class="label label-danger">¡Atención!: ¡No hay servidores disponibles!</div>
              <div class="table-responsive">
