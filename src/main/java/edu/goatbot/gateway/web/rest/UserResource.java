...
import edu.goatbot.gateway.config.Constants;
import edu.goatbot.gateway.domain.User;
import edu.goatbot.gateway.repository.UserRepository;
import edu.goatbot.gateway.security.AuthoritiesConstants;
import edu.goatbot.gateway.service.MailService;
import edu.goatbot.gateway.service.UserService;
import edu.goatbot.gateway.service.dto.AdminUserDTO;
import edu.goatbot.gateway.web.rest.errors.BadRequestAlertException;
import edu.goatbot.gateway.web.rest.errors.EmailAlreadyUsedException;
import edu.goatbot.gateway.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link edu.goatbot.gateway.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
