package edu.goatbot.gateway.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("edu.goatbot.gateway.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("edu.goatbot.gateway.security.DomainUserDetailsService", "createSpringSecurityUser");
